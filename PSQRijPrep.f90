MODULE PSQRijPrep
  use parallel_module, only: myrank,myrank_g,nprocs_g,np_grid,node_partition,COMM_GRID,disp_switch_parallel
...
! for grid-parallel computation
    ...
    allocate( maps_tmp(c_nzqr_0,3)        ) ; maps_tmp        =0
