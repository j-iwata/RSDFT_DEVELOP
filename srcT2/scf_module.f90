...
!    real(8),allocatable :: v(:,:,:)
    ...
    real(8) :: Ntot(4), sqerr_out(4), t_out(2,18), t_ini(2), t_tmp(2)
...
!       if ( myrank == 0 ) call write_eigenvalues( eval )
       ...
       write(*,'(1x,"elapsed_time ",f8.3,"(scf)" &
                                   ...
                                   ,t_out(2,4),t_out(2,5) &
                                   ,t_out(2,10) &
                                   ,t_out(2,1)+t_out(2,3)+sum( t_out(2,7:9) )+sum( t_out(2,11:13) )+sum( t_out(2,15:18) )
!      write(*,'(1x,"other ",12(1x,f8.3))') t_out(2,1),t_out(2,3),t_out(2,7:9),t_out(2,11:13),t_out(2,15:18)
       end if
