...
FFLAGS1 =
#################### Generate REAL8 code #####
#FFLAGS1 = -D_DRSDFT_ -D_FFTW_
#################### Generate COMPLEX16-USPP code #####
#FFLAGS1 = -D_USPP_
#################### SPLINE interpolation is used in prep_ps #####
#FFLAGS1 = -D_SPLINE_
#FFLAGS1 = -D_DRSDFT_ -D_SPLINE_
#################### FFTE is used #####
#FFLAGS1 = -D_FFTE_
#FFLAGS1 = -D_DRSDFT_ -D_FFTE_
#FFLAGS1 = -D_DRSDFT_ -D_SPLINE_ -D_FFTE_
#################### EIGEN is used #####
#FFLAGS1 = -D_DRSDFT_ -D_EIGEN_
############################################ Libraries & directories ###
#EigenExaLib = /home.org/iwata/rsdft/EigenExa-2.3c
#LIBS = $(EigenExaLib)/libEigenExa.a
INCLUDE_DIR = -I../
#INCLUDE_DIR = -I../ -I/home/iwata/fftw-3.3.4/include/
#INCLUDE_DIR = -I../ -I$(EigenExaLib)
########################################################################
##### INTEL                                                        #####
...
#FFLAGS0 = -openmp -cpp
#FFLAGS0 = -O3 -xHost -opt-report-phase=all -opt-report-file=$*.optlog -fpp -openmp
#FFLAGS0 = -cpp
#FFLAGS0 = -C -cpp
#FFLAGS0 = -C -openmp -cpp
#LFLAGS = -openmp
...
########################################################################
#
FFLAGS = $(FFLAGS0) $(FFLAGS1) $(INCLUDE_DIR)
#
########################################################################
.SUFFIXES:
.SUFFIXES: .o .f .f90
