...
c     &           *CG(l1_i,l2_i,m1_i,-m2_i,L_i,-M_i)
            ...
            i=i+1
c            write(*,'(1x,i3,2x,4i3,1x,2i3,1x,2f20.16)')
c     &           i,l1_i,m1_i,L_i,M_i,l2_i,m2_i,real(zc),aimag(zc)
            if ( j == 1 ) then
               write(*,'(7x,"Y1(",i2,3(",",i2),") =",f19.15,"d0")') 
     &         l1_i,m1_i,L_i,M_i,real(zc)
            else if ( j == 2 ) then
               write(*,'(7x,"Y2(",i2,3(",",i2),") =",f19.15,"d0")') 
     &         l1_i,m1_i,L_i,M_i,real(zc)
            else if ( j == 3 ) then
               write(*,'(7x,"Y3(",i2,3(",",i2),") =",f19.15,"d0")') 
     &         l1_i,m1_i,L_i,M_i,real(zc)
            end if
