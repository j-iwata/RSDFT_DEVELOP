PROGRAM band_sort
  ...
  integer,parameter :: u1=100,u2=110,max_loop=100000
...
!------------------------------
  ...
  open(u2,file="band_eigv_sort")

  write(u2,'(1x,3f20.15)') bb(1:3,1)
  write(u2,'(1x,3f20.15)') bb(1:3,2)
  write(u2,'(1x,3f20.15)') bb(1:3,3)
  do i=1,nbk
     write(u2,'(1x,2i6,3f20.12,i8)') i,mb,dk_bz(1:3,i),mbv
     do j=1,mbi(i)
        write(u2,'(1x,i5,2x,2(1x,g22.12,1x,g15.5))') j,(eval(j,i,s),0.0,s=1,msp)
     end do
  end do
  close(u2)
