module z_subspace_mate_sl2_module

  implicit none

  private
  public :: z_subspace_mate_sl2
...
contains
  ...
  subroutine z_subspace_mate_sl2( k, s, u )
    ...
    do ib = nb_0, nb_1, blk_size
      ...
      do iblock = 1, num_blocks_myrnk-1
        ...
        if ( ms_next <= nb ) then
          ...
          call ZGEMM('C','N',nn,mm,mg,zdV,hu,mg,u(1,ms),mg,z0,uhu,nn)
      ...
      if ( np_band_is_odd ) then
        ...
        if ( myrank_b <= np_band/2-1 ) then
          ...
          call ZGEMM('C','N',mm,nn,mg,zdV,u(1,ms),mg,hu(1,nh-ns+1),mg,z0,uhu,mm)
  ...
  end subroutine z_subspace_mate_sl2

end module z_subspace_mate_sl2_module
