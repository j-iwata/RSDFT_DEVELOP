...
!$  use omp_lib
  ...
  private
  public :: d_op_kinetic_sol
  public :: d_construct_matrix_kinetic_sol
...
contains
  ...
  subroutine d_op_kinetic_sol( tpsi, htpsi, k_in, vloc )
    implicit none
...
!$OMP end master
  ...
  end subroutine d_op_kinetic_sol


  subroutine d_construct_matrix_kinetic_sol( k, ML, Hmat )
    implicit none
  ...
  end subroutine d_construct_matrix_kinetic_sol


end module d_kinetic_sol_module
