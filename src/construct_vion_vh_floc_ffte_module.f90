module construct_vion_vh_floc_ffte_module
  ...
  private
  public :: construct_vion_vh_floc_ffte
...
contains
  ...
  subroutine construct_vion_vh_floc_ffte( rho, Vion, Vh, force_local, Eh )
    implicit none
    ...
    !call write_border( 1, " construct_vion_vh_floc_ffte(start)" )
...
!$OMP end parallel do
    ...
    !call write_border( 1, " construct_vion_vh_floc_ffte(end)" )

  end subroutine construct_vion_vh_floc_ffte
  ...
  subroutine initial_preparation
    ...
    do i=1,size(LLG,2)
      ...
      if ( a2b <= i2 .and. i2 <= b2b .and. a3b <= i3 .and. i3 <= b3b ) n=n+1
    end do
...
end module construct_vion_vh_floc_ffte_module
