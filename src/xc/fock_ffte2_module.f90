module fock_ffte2_module
  ...
  use omp_variables
  use pzfft3dv_arb_module, only: pzfft3dv_arb

  implicit none

  private
  public :: init_fock_ffte2
  public :: fock_ffte2
  public :: fock_ffte2_double
...
contains
  ...
  subroutine init_fock_ffte2

    implicit none
    integer :: n,i,i1,i2,i3,j1,j2,j3,a1b,b1b,a2b,b2b,a3b,b3b
    real(8) :: g2,pi,c
    ...
    do i=1,NGgrid(0)
      ...
      if ( a1b<=i1.and.i1<=b1b .and. a2b<=i2.and.i2<=b2b .and. a3b<=i3.and.i3<=b3b ) then
        n=n+1
      end if
    end do ! i
...
!$  use omp_lib
    ...
    if ( first_time ) call init_fock_ffte2
...
!$OMP end parallel
  ...
  end subroutine fock_ffte2_double


end module fock_ffte2_module
