...
!DIR$ ATTRIBUTES ALIGN : 64 :: C,D,WX,WY,WZ
...
!$OMP DO COLLAPSE(2) PRIVATE(J)
   ...
   10   CONTINUE
   20 CONTINUE
!$OMP DO COLLAPSE(3) PRIVATE(I,II,J,JJ,L)
      DO 110 K=1,NNZ
        DO 100 L=1,NPU
          DO 90 II=1,NNX,NBLK
            DO 50 JJ=1,NY,NBLK
