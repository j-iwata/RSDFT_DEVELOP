...
contains
  ...
  subroutine calc_force_local_fftw( force )
    implicit none
    real(8),intent(out) :: force(:,:)
    integer :: ispin,i,i1,i2,i3,ik,a,j,ierr,irank,N_MI,n
    integer :: ML1,ML2,ML3,ML,MG,ML_0,j1,j2,j3,MI
    ...
    call write_border( 1, ' calc_forece_local_fftw(start)' )
...
!      write(*,*) "time(force_local_fftw_1)=",ctt(1)-ctt(0),ett(1)-ett(0)
!      write(*,*) "time(force_local_fftw_2)=",ctt(2)-ctt(1),ett(2)-ett(1)
!      write(*,*) "time(force_local_fftw_3)=",ctt(3)-ctt(2),ett(3)-ett(2)
!      write(*,*) "time(force_local_fftw_4)=",ctt(4)-ctt(3),ett(4)-ett(3)
!      write(*,*) "time(force_local_fftw_5)=",ctt(5)-ctt(4),ett(5)-ett(4)
!      write(*,*) "time(force_local_fftw_6)=",ctt(6)-ctt(5),ett(6)-ett(5)
!      write(*,*) "time(force_local_fftw_7)=",ctt(7)-ctt(6),ett(7)-ett(6)
!      write(*,*) "time(force_local_fftw_8)=",ctt(8)-ctt(7),ett(8)-ett(7)
!    end if

    call write_border( 1, ' calc_forece_local_fftw(end)' )
