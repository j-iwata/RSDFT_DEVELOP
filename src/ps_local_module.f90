...
#ifdef _FFTE_
    !call construct_ps_local_ffte_bak
...
!    if ( disp_sw ) then
!      write(*,*) "time(construct_ps_local_1)",ctt(1)-ctt(0),ett(1)-ett(0)
!      write(*,*) "time(construct_ps_local_2)",ctt(2)-ctt(1),ett(2)-ett(1)
!      write(*,*) "time(construct_ps_local_3)",ctt(3)-ctt(2),ett(3)-ett(2)
!    end if
